...
export default function TestimonialBadge({}: Props) {
  return (
    <div className="flex flex-col justify-center items-center space-x-2 sm:inline-flex sm:flex-row">
      <a
        href="https://www.linkedin.com/posts/alexwang2911_opensource-technology-gpt-activity-7160572862922133504-XkTJ/"
        target="_blank"
      >
      ...
      <div className="flex flex-col justify-center items-center space-y-1 text-center sm:items-start">
        <div className="inline-flex space-x-1 text-yellow-400">
          <svg
        ...
        <div className="text-zinc-500">trusted by 14,000+ businesses</div>
      </div>
    </div>
  );
}
