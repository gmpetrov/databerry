...
export default function PartnerLogos() {
    return (
      <div className="bg-black py-24 sm:py-32">
        <div className="mx-auto flex flex-col justify-center max-w-7xl px-6 lg:px-8">
          <h2 className="text-center text-xl font-display leading-12 text-white pb-9">
          Earning the trust of the world&apos;s most innovative teams
          </h2>
          <div className="mx-auto mt-10 grid grid-cols-1 place-items-center xs:grid-cols-2 items-center gap-x-10 gap-y-10  sm:grid-cols-3 sm:gap-x-10 lg:mx-0 lg:max-w-none lg:grid-cols-4">
            <Image
              loading="lazy"
