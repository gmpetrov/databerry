...
export class ScriptsPro extends Scripts {
  ...
  moveToDelayedProArgs(jobId, timestamp, token, gid) {
    ...
    const keys = ["wait", "active", "priority", "delayed", jobId].map(
      (name) => {
  ...
  moveToFinishedArgs(
    ...
    keys[9] = this.queue.toKey(
      (_a = job.id) !== null && _a !== void 0 ? _a : ""
    );
    keys[11] = metricsKey;
    ...
    const args = [
      ...
      pack({
        ...
        maxMetricsSize: (
          (_b = opts.metrics) === null || _b === void 0
            ? void 0
            : _b.maxDataPoints
        )
          ? (_c = opts.metrics) === null || _c === void 0
            ? void 0
            : _c.maxDataPoints
          : "",
        fpof: !!((_d = job.opts) === null || _d === void 0
          ? void 0
          : _d.failParentOnFailure),
      }),
    ];
  ...
  moveToWaitingChildrenProArgs(jobId, token, gid, opts) {
    ...
    return keys.concat([
      ...
      JSON.stringify(timestamp),
      jobId,
      (_a = workerOpts.group) === null || _a === void 0
        ? void 0
        : _a.concurrency,
    ]);
  }
  ...
  async repairMaxedGroup(groupId) {
    ...
    return client.repairMaxedGroup(
      keys.concat([groupId, this.queue.toKey("")])
    );
  }
}
