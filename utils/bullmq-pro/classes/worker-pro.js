...
export class WorkerPro extends Worker {
  constructor(name, processor, opts) {
    ...
    if (
      ((_a = opts === null || opts === void 0 ? void 0 : opts.group) === null ||
      _a === void 0
        ? void 0
        : _a.limit) &&
      ((_b = opts === null || opts === void 0 ? void 0 : opts.group) === null ||
      _b === void 0
        ? void 0
        : _b.concurrency)
    ) {
    ...
    const ttlType = typeof (opts === null || opts === void 0
      ? void 0
      : opts.ttl);
  ...
  async callProcessJob(job, token) {
    ...
    if (isObservable(result)) {
      ...
      if (this.opts.ttl) {
        const ttl =
          typeof this.opts.ttl === "number"
            ? this.opts.ttl
            : (_a = this.opts) === null || _a === void 0
            ? void 0
            : _a.ttl[job.name];
  ...
  async rateLimitGroup(job, expireTimeMs) {
    ...
    const opts = job.opts;
    const groupId =
      (_a = opts.group) === null || _a === void 0 ? void 0 : _a.id;
