...
export declare class QueueEventsPro extends QueueEvents {
  ...
  emit<U extends keyof QueueEventsListenerPro>(
    event: U,
    ...args: Parameters<QueueEventsListenerPro[U]>
  ): boolean;
  off<U extends keyof QueueEventsListenerPro>(
    eventName: U,
    listener: QueueEventsListenerPro[U]
  ): this;
  on<U extends keyof QueueEventsListenerPro>(
    event: U,
    listener: QueueEventsListenerPro[U]
  ): this;
  once<U extends keyof QueueEventsListenerPro>(
    event: U,
    listener: QueueEventsListenerPro[U]
  ): this;
}
